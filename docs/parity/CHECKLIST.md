...
- [ ] ⚠️ Field: mã mẫu, số seri, số lượng, ngày nhận, vị trí lưu trữ, trạng thái mẫu (auto: received/testing/completed/returned) — cần xác nhận field "vị trí lưu trữ" + auto-status
- [ ] ❌ Group theo dự án, thẻ có thể thu gọn (`data-toggle-group`), thanh tiến độ %/nhóm
- [ ] ❌ 4 KPI card + chip lọc trạng thái + filter theo khách hàng
- [ ] ❌ Nút "+ Thêm mẫu" ngay trong nhóm dự án (tự tạo TestPlan nếu dự án chưa có)
